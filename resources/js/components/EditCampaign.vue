<template>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Edit Campaign
...
<script>
    export default {
        ...
        created() {
            ...
            this.axios
                .get(`http://localhost/api/campaigns/${this.$route.params.id}`)
                .then(response => {
        ...
        methods: {
            ...
            submit() {
                ...
                axios.post(`http://localhost/api/campaigns/${this.$route.params.id}?_method=PUT`, formData, config).then(response => {
